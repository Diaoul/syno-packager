...
sub showPage {
	...
	print $q->start_tfoot,
		$q->start_Tr,
		$q->td($q->textfield(-name=>'minute', -value=>'', -maxlength=>4, -size=>5)),
		$q->td($q->textfield(-name=>'hour', -value=>'', -maxlength=>4, -size=>5)),
		$q->td($q->textfield(-name=>'dom', -value=>'', -maxlength=>4, -size=>5)),
		$q->td($q->textfield(-name=>'month', -value=>'', -maxlength=>4, -size=>5)),
		$q->td($q->textfield(-name=>'dow', -value=>'', -maxlength=>4, -size=>5)),
