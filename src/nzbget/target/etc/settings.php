...
$ServerConfigFile='/usr/local/nzbget/etc/nzbget.conf';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$ServerConfigTemplate='/usr/local/nzbget/etc/nzbget.conf.example';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$NzbDir='/usr/local/nzbget/downloads';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$PostProcessConfigFile='/usr/local/nzbget/share/postprocess-example.conf';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$PostProcessConfigTemplate='/usr/local/nzbget/share/postprocess-example.sh';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$CheckSpaceDir='/home/user/nzbget/dst';
